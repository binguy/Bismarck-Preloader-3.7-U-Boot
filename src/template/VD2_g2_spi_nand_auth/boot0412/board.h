...
#define IS_RLE0822			((*((volatile unsigned int *)0xB8000000) == 0x00000822)?1:0)
#define IS_RL6518			((*((volatile unsigned int *)0xB8000000) == 0x00006518)?1:0)
#define IS_Bond_RTL8685G	((*((volatile unsigned int *)0xB8000100)>>14) & 1)
...
#ifndef CONFIG_IMAGE_NAND_DUAL
	unsigned long	reserved[1];		/* Reserved,	offset 0x003C */
#else
	unsigned long	img_select;			/* Image selection for NAND Dual image */
#endif
...
#define IMAGE_LOCATION_FLAG_ADDR		(FLASH_BASE_ADDR+0x000A0000)
#define FIRST_IMAGE_ADDR			(FLASH_BASE_ADDR+0x00100000)
#define SECOND_IMAGE_ADDR			(FLASH_BASE_ADDR+0x00800000)
#else 
#ifdef SUPPORT_Z_NEW_LAYOUT
...
#define SECOND_IMAGE_ADDR			(0xBD800000)
#endif
#endif
