...
#define CCTL2_SET_FUNC_BODY(fld)	{ asm_mtc0_2(((asm_mfc0_2(CCTL_REG)&~(0x3<<CCTL2_##fld##_OFFSET))|(value<<CCTL2_##fld## _OFFSET)), CCTL_REG);}
#define CCTL2_GET_FUNC_BODY(fld)	{ *result=((asm_mfc0_2(CCTL_REG)>>CCTL2_##fld##_OFFSET)&0x3);}
