...
void bus_async_sw_patch_4_ddr3(void)
{
    ...
    printf("II: Setting for Bus_async\n");
}


#include <dram/memcntlr_util.h>
#include <dram/autok/dram_autok.c>
#include <dram/autok/dram_autok_calibration.c>
#include <dram/autok/dram_autok_config.c>
