...
u8_t ft_result=0; //bit0: ZQ PASS=0 FAIL=1,  bit1: window Normal=0 Small=1

/* global variable for DRAM Efuse patch*/
u8_t EFPH_patch_num=0;	//0:no patch  1:use efuse patch 1  2:use efuse patch 2

u8_t EFPH_CLK_OCD=0;
u8_t EFPH_Addr_OCD=0;
u8_t EFPH_DQS_OCD=0;
u8_t EFPH_DQ_OCD=0;

u8_t EFPH_Ctrl_ODT=0;
u8_t EFPH_DRAM_ODT=0;
u8_t EFPH_DRAM_driving=0;
u8_t EFPH_HCLK=0;
u8_t EFPH_DQS_delay=0;
u8_t EFPH_DQSEN=0;

u8_t EFPH_Addr_delay=0;
u8_t EFPH_DQR_delay=0;
u8_t EFPH_DQW_delay=0;
u8_t EFPH_DM_delay=0;

u8_t EFPH_ZQ_en=0;
u8_t EFPH_DRAM_ZQ_en=0;
u8_t EFPH_DQSEN_en=0;
u8_t EFPH_DQS_delay_en=0;
u8_t EFPH_Addr_delay_en=0;
u8_t EFPH_DQR_delay_en=0;
u8_t EFPH_DQW_delay_en=0;
u8_t EFPH_DM_delay_en=0;
u8_t EFPH_Patch1_en=0;
u8_t EFPH_Patch2_en=0;

u8_t EFVD_Capacity=0;
u8_t EFVD_Vendor=0;
u8_t EFVD_type=0;
u8_t EFVD_other=0;
u32_t EFVD_hex=0;
...
uint32 Efuse_DRAM_patch(void){
	...
	EFVD_hex = efuse_read(243);
//	printf("EFVD_hex=0x%x\n", EFVD_hex);

	EFBD_spec = (efuse_read(3)>>9) & 0x1;
...
unsigned int DDR3_DTR[13][3] __attribute__ ((section(".text")))={
		...
		if(xlat_dram_size_num()==NA){	//For discrete
			switch(dram_freq_mhz){
				...
				case 600:
					...
					REG32(DDR_DELAY_CTRL_REG1)=0x0d0d0fff;
...
// For RTL9603C-vd
MEM_PLL_INFO_SECTION mem_pll_info_t rtl9603cvd_ddr2_pll[] = {
...
MEM_PLL_INFO_SECTION mem_pll_info_t rtl9603cvd_ddr3_pll[] = {
...
MEM_PLL_INFO_SECTION mem_pll_info_t rtl9603cvd_ddr2_mcm_pll[] = {
    {.mhz=525, .pll0=0x0000307f, .pll1=0xc0000210, .pll2=0x26622760, .pll3=0x270f0030},
    {.mhz=500, .pll0=0x0000307f, .pll1=0xc0000210, .pll2=0x26622760, .pll3=0x250f0030},
    {.mhz=450, .pll0=0x0000307f, .pll1=0xc0000210, .pll2=0x26622760, .pll3=0x210f0030},
    {.mhz=400, .pll0=0x0000307f, .pll1=0xc0000210, .pll2=0x26622760, .pll3=0x1d0f0030},
...
MEM_PLL_INFO_SECTION mem_pll_info_t rtl9603cvd_ddr3_mcm_pll[] = {
	{.mhz=800, .pll0=0x0000307f, .pll1=0xc0000231, .pll2=0x2ea23980, .pll3=0x3d0f0031},
	{.mhz=750, .pll0=0x0000307f, .pll1=0xc0000210, .pll2=0x2ea23980, .pll3=0x390f0030},
	{.mhz=700, .pll0=0x0000307f, .pll1=0xc0000210, .pll2=0x2ea23980, .pll3=0x350f0030},
    {.mhz=650, .pll0=0x0000307f, .pll1=0xc0000210, .pll2=0x2ea23980, .pll3=0x310f0030},
...
// For Apollo pro Gen2
MEM_PLL_INFO_SECTION mem_pll_info_t apro_gen2_ddr2_pll[] = {
    {.mhz=525, .pll0=0x0000807f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x270f0030},
    {.mhz=500, .pll0=0x0000807f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x250f0030},
    {.mhz=450, .pll0=0x0000807f, .pll1=0xc0000210, .pll2=0x064227A0, .pll3=0x210f0030},
    {.mhz=400, .pll0=0x0000807f, .pll1=0xc0000210, .pll2=0x04422780, .pll3=0x1d0f0030},
    {.mhz=300, .pll0=0x0000207f, .pll1=0x80000210, .pll2=0x04423780, .pll3=0x150f0030},
    {.mhz=200, .pll0=0x0000007f, .pll1=0x00000210, .pll2=0x06023540, .pll3=0x0d0f0030},
    {.mhz=  0, .pll0=0         , .pll1=0         , .pll2=0         , .pll3=0         },
};

MEM_PLL_INFO_SECTION mem_pll_info_t apro_gen2_ddr3_pll[] = {
	{.mhz=800, .pll0=0x0011007f, .pll1=0xc0000231, .pll2=0x064237C0, .pll3=0x3d0f0031},
	{.mhz=750, .pll0=0x0010a07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x390f0030},
	{.mhz=700, .pll0=0x0010a07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x350f0030},
    {.mhz=666, .pll0=0x0008f07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x320f0030, .pll5=0xA7F},
    {.mhz=650, .pll0=0x0008f07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x320f0030},
	{.mhz=600, .pll0=0x0008f07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x2d0f0030},
    {.mhz=550, .pll0=0x0008f07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x290f0030},
    {.mhz=525, .pll0=0x0008f07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x270f0030},
    {.mhz=500, .pll0=0x0008f07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x250f0030},
    {.mhz=450, .pll0=0x0000807f, .pll1=0xc0000210, .pll2=0x064227A0, .pll3=0x210f0030},
    {.mhz=400, .pll0=0x0000807f, .pll1=0xc0000210, .pll2=0x04422780, .pll3=0x1d0f0030},
    {.mhz=300, .pll0=0x0000807f, .pll1=0x80000210, .pll2=0x04423780, .pll3=0x150f0030},
    {.mhz=200, .pll0=0x0000007f, .pll1=0x00000210, .pll2=0x06023540, .pll3=0x0d0f0030},
    {.mhz=  0, .pll0=0         , .pll1=0         , .pll2=0         , .pll3=0         },
};

MEM_PLL_INFO_SECTION mem_pll_info_t apro_gen2_ddr2_mcm_pll[] = {
    {.mhz=525, .pll0=0x0000607f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x270f0030},
    {.mhz=500, .pll0=0x0000607f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x250f0030},
    {.mhz=450, .pll0=0x0000207f, .pll1=0xc0000210, .pll2=0x064227A0, .pll3=0x210f0030},
    {.mhz=400, .pll0=0x0000207f, .pll1=0xc0000210, .pll2=0x04422780, .pll3=0x1d0f0030},
    {.mhz=300, .pll0=0x0000207f, .pll1=0x80000210, .pll2=0x04423780, .pll3=0x150f0030},
    {.mhz=200, .pll0=0x0000007f, .pll1=0x00000210, .pll2=0x06023540, .pll3=0x0d0f0030},
    {.mhz=  0, .pll0=0         , .pll1=0         , .pll2=0         , .pll3=0         },
};

MEM_PLL_INFO_SECTION mem_pll_info_t apro_gen2_ddr3_mcm_pll[] = {
	{.mhz=800, .pll0=0x0011007f, .pll1=0xc0000231, .pll2=0x064237C0, .pll3=0x3d0f0031},
	{.mhz=750, .pll0=0x0010a07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x390f0030},
	{.mhz=700, .pll0=0x0010a07f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x350f0030},
    {.mhz=666, .pll0=0x0000907f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x320f0030, .pll5=0xA7F},
    {.mhz=650, .pll0=0x0000907f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x310f0030},
	{.mhz=600, .pll0=0x0000907f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x2d0f0030},
    {.mhz=550, .pll0=0x0000907f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x290f0030},
    {.mhz=525, .pll0=0x0000907f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x270f0030},
    {.mhz=500, .pll0=0x0000907f, .pll1=0xc0000210, .pll2=0x064237C0, .pll3=0x250f0030},
    {.mhz=450, .pll0=0x0000407f, .pll1=0xc0000210, .pll2=0x064227A0, .pll3=0x210f0030},
    {.mhz=400, .pll0=0x0000407f, .pll1=0xc0000210, .pll2=0x04422780, .pll3=0x1d0f0030},
    {.mhz=300, .pll0=0x0000407f, .pll1=0x80000210, .pll2=0x04423780, .pll3=0x150f0030},
    {.mhz=200, .pll0=0x0000007f, .pll1=0x00000210, .pll2=0x06023540, .pll3=0x0d0f0030},
    {.mhz=  0, .pll0=0         , .pll1=0         , .pll2=0         , .pll3=0         },
};
...
void WL_workaroud(int loop){
	unsigned int i;
	for(i=0; i<loop; i++){
		REG32(0xa0000000)=0x1234cafe;
		REG32(0xa0000004) = REG32(0xB8001594);
		REG32(0xa0000008) = REG32(0xB8001598);
		REG32(0xa000000c) = REG32(0xB800159c);
		REG32(0xa0000010) = REG32(0xB80015a0);
//		printf("i=%d, fifo= 0x%x, 0x%x, 0x%x, 0x%x\n",i , fifo[0], fifo[1], fifo[2], fifo[3]);
	}
}
...
void Write_Leveling(unsigned char apply){
	...
	unsigned char i;
	uint32 *dcfdrr0,*dcfdrr1,*dcfdfr0,*dcfdfr1,*dmcr,dmcr_tmp;
	uint32 PLL0_good=0,chg;
...
int address_toggle(){
	...
	unsigned int spcl_val, err=0;
	unsigned int max_addr_sft, addr_bit, addr=0xFFFFFFF;
	const unsigned int col_bit=10, bank_bit=3;
	volatile unsigned int addr_0;

	
	switch (EFVD_Capacity){
		case 1:	//512Mb A0~11=12
			max_addr_sft = 12 + col_bit + bank_bit - 1; break;
		case 2:	//1Gb A0~12=13
			max_addr_sft = 13 + col_bit + bank_bit - 1; break;
		case 3:	//2Gb A0~13=14
			max_addr_sft = 14 + col_bit + bank_bit - 1; break;
		case 4:	//4Gb A0~14=15
			max_addr_sft = 15 + col_bit + bank_bit - 1; break;
		default:  //error
			max_addr_sft = 0xFFFFFFFF;
	}
	max_addr_sft = max_addr_sft + 1;
//	printf("debug: max_addr_sft=%d\n", max_addr_sft);

	// write address 0 = 0

	for(addr_bit=col_bit; addr_bit<=max_addr_sft; addr_bit++){
		// addr 0 clear
		addr_0 = MEM_BASE + 0;
		REG32(addr_0) = 0;

		addr = MEM_BASE + (1 << addr_bit);
		// write address
		REG32(addr) = 0xcafe9999;	//0xcafe9999 is no point
//		debug("write addr(0x%x) = 0x%x\n", addr, REG32_ARM(addr));

		// write address check
		spcl_val = REG32(addr);
		if (spcl_val != 0xcafe9999){
			printf("error: write check addr(0x%x) = 0x%x (!=0xcafe9999)\n", addr, spcl_val);
			err = 1;
			return err;
		}
		// read address
		spcl_val = REG32(addr_0);
//		debug("read addr 0(0x%x) = 0x%x\n", addr_0, spcl_val);

		if (spcl_val == 0xcafe9999){
			printf("error: 0x%x is FAIL, please check A%d(or BA) connection\n", addr, addr_bit-col_bit-1);
			err = 1;
		}
	}
	return err;
...
#define DDR_AK_VERSION (0x00050005) //V5.5 = 0x0005_0005
symb_idefine(
	ddr_ak_version,
	ENV_DDR_AK_VERSION,
	DDR_AK_VERSION
...
/*********** U28 DRAM calibration V5.5 20221011 **************
 ...
 V4.3: optimize code
 V5.0: RL6831 frist version
 V5.1: RL6831 up to DDR3-1333. Fine turn PLL PI
 V5.2: Modify DDR3 ODT of contorller to 60
 V5.4: Fix dram init. fail issue for specific dram model (workaround)
 V5.5: patch for RL6537 RTL9607C-VAJ
************************************************************/

void memctlc_init_dram(void)
{
    printf("AK: ******* DRAM calibration version: v%d.%d *******\n", (DDR_AK_VERSION>>16)&0xFFFF, DDR_AK_VERSION&0xFFFF);
	...
	struct ZQ_Value APRO_DDR3_VALUE[] = {
		{.group = "  Clock",	.ODT = 60, .OCD = 60},
		{.group = "Address",	.ODT = 60, .OCD = 53},
		{.group = "     DQ",	.ODT = 60, .OCD = 48},
		{.group = "    DQS",	.ODT = 60, .OCD = 48},
	};

	struct ZQ_Value APRO_DDR3_MCM_VALUE[] = {
		{.group = "  Clock",	.ODT = 60, .OCD = 48},
		{.group = "Address",	.ODT = 60, .OCD = 80},
		{.group = "     DQ",	.ODT = 60, .OCD = 60},
		{.group = "    DQS",	.ODT = 60, .OCD = 60},
	};
...
//	while(delay_loop--);
    ...
    mem_clk_mhz = GET_MEM_MHZ();
#endif
	printf("AK: DRAM type = %s, Freq. = %d MHz\n", memctlc_DDR_Type()==IS_DDR3_SDRAM ? "DDR3" : "DDR2", mem_clk_mhz);
	...
	//patch for RTL9607C-VAJ
	if((_soc.sid == PLR_SID_APRO) && xlat_chip_mode()==ST_RTL9607C && EFVD_hex==0x3332 && EFBD_spec==1)	//patch for RTL9607C-VAJ
		APRO_DDR3_MCM_VALUE[2].OCD=40;
...
//	printf("AK: Address toggle %s\n", address_toggle()==0 ? "PASS" : "FAIL");
