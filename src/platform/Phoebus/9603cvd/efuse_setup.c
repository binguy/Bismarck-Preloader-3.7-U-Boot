...
unsigned short rtl9603cvd_efuse_read_entry(unsigned char entry)
{
	REG32(0xbb000020)= (1<<16)|entry;
	udelay(1);
	while(REG32(0xbb000024) & (1<<16));
	return (REG32(0xbb000024) & 0xFFFF);
}
...
void rtl9603cvd_efuse_setup_fcn(void) {
	if (_efuse_is_fpga()) {
		return;
	}
