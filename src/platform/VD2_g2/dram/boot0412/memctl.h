...
/* vvv ZQ calibration for RTL8685SB vvv */
...
/* Expose memctlc error to outside world. Each bit stands for an error status.
   0: ZQ Fail.
   1 ~ 31: to be defined.
*/
extern unsigned int memctlc_err_map;
#define MEMCTLC_ERR_ZQ_FAIL (0x1)
