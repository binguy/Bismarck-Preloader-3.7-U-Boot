...
#define BURST_LEN    (0)    /* 0: 16B; 1: 32B, 2: 64B, 3: 128B */
#define PACKAGE_LEN  (32) /* from 32B ~ 8160B in a unit of 32B. */
#define PERIOD_CYCLE (4)    
btg_para_v3_t btg_parameter[] = {
    {
        ...
        .perid_time = PERIOD_CYCLE, /* in cycles. */
