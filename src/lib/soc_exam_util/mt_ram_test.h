...
extern int mt_ram_simple_normal_test(u32_t addr, u32_t size);
extern int mt_ram_unaligned_wr(u32_t addr, u32_t size);

extern int mt_highmem_test(u32_t max_size);
extern int mt_highmem_simple_normal_test(u32_t max_size);
