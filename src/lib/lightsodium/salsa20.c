...
int
crypto_stream_salsa20(unsigned char *c, unsigned long long clen, const unsigned char *n,
...
static int
_crypto_stream_salsa20_xor_ic(unsigned char *c, const unsigned char *m,
...
crypto_stream_salsa20_xor_ic(unsigned char *c, const unsigned char *m,
                             ...
                             const unsigned char *k)
{
    return _crypto_stream_salsa20_xor_ic(c, m, mlen, n, ic, k);
}
...
crypto_stream_salsa20_xor(unsigned char *c, const unsigned char *m,
                          ...
                          const unsigned char *k)
{
    return _crypto_stream_salsa20_xor_ic(c, m, mlen, n, 0U, k);
}