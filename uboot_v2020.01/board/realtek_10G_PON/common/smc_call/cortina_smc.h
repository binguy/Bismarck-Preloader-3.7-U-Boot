...
#define CA_SVC_OTP_JTAG_PWD_READ    (SIP_SVC_CALL|CA_SVC_OTP|5)
#define CA_SVC_OTP_JTAG_PWD_WRITE   (SIP_SVC_CALL|CA_SVC_OTP|6)
...
u64 ca_otp_smc_call(unsigned int smc_id, unsigned long b_loc,  unsigned long b_len, unsigned long src, unsigned long x4);

#define CA_SMC_CALL_OTP_READ_ROTPK()         ca_otp_smc_call(CA_SVC_OTP_ROTPK_READ,      0, 0, 0,   0)
#define CA_SMC_CALL_OTP_WRITE_ROTPK(src)     ca_otp_smc_call(CA_SVC_OTP_ROTPK_WRITE,     0, 0, src, 0)
#define CA_SMC_CALL_OTP_READ_JTAG_PWD()      ca_otp_smc_call(CA_SVC_OTP_JTAG_PWD_READ,   0, 0, 0,   0)
#define CA_SMC_CALL_OTP_WRITE_JTAG_PWD(src)  ca_otp_smc_call(CA_SVC_OTP_JTAG_PWD_WRITE,  0, 0, src, 0)
#define CA_SMC_CALL_OTP_READ_CHIP_MODE(src)  ca_otp_smc_call(CA_SVC_OTP_CHIP_MODE_READ,  0, 0, src, 0)
#define CA_SMC_CALL_OTP_READ_DRAM_MODEL(src) ca_otp_smc_call(CA_SVC_OTP_DRAM_MODEL_READ, 0, 0, src, 0)
#define CA_SMC_CALL_GET_ROM_VERSION()        ca_otp_smc_call(CA_SVC_GET_ROM_VERSION,     0, 0, 0,   0)
#define CA_SMC_CALL_GET_ATF_VERSION()        ca_otp_smc_call(CA_SVC_GET_ATF_VERSION,     0, 0, 0,   0)
